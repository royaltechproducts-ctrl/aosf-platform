        ...
        <div>
          ...
          <div className="footer">
            ...
            <div style={{fontSize:13,color:GOLD,fontStyle:"italic",marginBottom:8,fontWeight:600}}>
              "Cultivating the power of sharing to receive multiple-fold in scholarship grants anywhere in the world"
            </div>
