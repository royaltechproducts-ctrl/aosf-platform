        ...
        <div>
            ...
            <div className="section" style={{padding:"0 24px"}}>
              ...
              <div className="steps">
                {[
                  ...
                  ["5","Receive USD 1.00 per Application from your Extended Outreach","Applications from the outreach links of applicants from your indirect outreach result in yet another wave of USD 1.00 credited to your scholarship account per application — students you have never met funding your education."],
          ...
          <div className="footer">
            ...
            <div style={{fontSize:13,color:GOLD,fontStyle:"italic",marginBottom:8,fontWeight:600}}>
              "Cultivating the power of sharing and receiving multiple-fold in scholarship grants anywhere in the world."
            </div>
          ...
          {portalTab==="payment" && !applicant.appFeePaid && (
            <>
              <div style={{fontWeight:900,fontSize:20,color:GREEN_DARK,marginBottom:6}}>
                Activate Your Scholarship Account to Unlock Your Unique Outreach Link — Donate USD {APP_FEE_USD}.00
              </div>
                ...
                <>
                  ...
                  <div style={{marginTop:24}}>
                    ...
                    {[
                      ...
                      const template = "🎓 \"Cultivating the power of sharing and receiving multiple-fold in scholarship grants anywhere in the world..\"\n\nA student has shared this opportunity with you — and it could change your academic journey.\n\nThe Academic Outreach Scholarship Program (AOSP) is a student-powered scholarship programme open to students globally. Your outreach generates real donated scholarship funds credited directly into your scholarship account.\n\nHow it works:\n📌 As a student applicant, simply activate a scholarship account on the platform to unlock a unique outreach link for yourself by either submitting proof of academic merit, or proof of social outreach, or by simply becoming a one-time donor on the platform with " + t.amount + " to unlock your unique outreach link for your scholarship funding\n📌 Every student who applies through your link = USD 1.00 credited to your scholarship account on the platform\n📌 Here is where the Magic happens — You get USD 1.00 credited into your scholarship account again and again every time applicants from your link generate more applications from their own outreach links\n📌 To activate your scholarship account and quick start your scholarship journey, apply as a one-time donor on the platform. Make a small donation to activate your scholarship account via " + t.payment + " — no hassle\n📌 Cash out your scholarship funds to your local bank account anytime\n\nYour outreach link — once unlocked and shared with this message template, aspires to reach over 5,700 institutions across Africa, USA, UK, & Canada by extended circulation.\n\nThis opportunity was shared with you. If you are not a student, please pass it on. If you are a student in any tertiary institution in Africa, or an International Student in the UK, USA or Canada, then don\'t just pass it on — ensure you apply, unlock your own unique outreach link, and start a trend that makes you a direct beneficiary.\n\n🔗 Apply here:\n" + outreachLink;
                      return (
            ...
            {[
              ...
              },
              {
                ...
                items:[
                  ...
                  "Credits are generated only when the referred applicant's donation to unlock and activate their own link is confirmed. Pending donations, Activation by Academic Merit, and Activation via Social Outreach do not generate credits.",
